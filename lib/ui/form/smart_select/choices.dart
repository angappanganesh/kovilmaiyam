...
List<S2Choice<String>> tamilmonth_type = [
  ...
  S2Choice<String>(value: 'puratasi', title: 'Puratasi'),
  S2Choice<String>(value: 'aypasi', title: 'Aypasi'),
  S2Choice<String>(value: 'karthigai', title: 'Karthigai'),
  S2Choice<String>(value: 'margazhi', title: 'Margazhi'),
  S2Choice<String>(value: 'tai', title: 'Tai'),
...
List<S2Choice<String>> nakshatra_type = [
  ...
  S2Choice<String>(value: 'barani', title: 'Barani'),
];
...
// Districts
List<S2Choice<String>> districts = [
  S2Choice<String>(value: 'vad', title: 'Monday'),
  S2Choice<String>(value: 'kod', title: 'Tuesday'),
  S2Choice<String>(value: 'rav', title: 'Wednesday'),
];

List<S2Choice<String>> zones = [
  S2Choice<String>(value: 'vzon1', title: 'Monday'),
  S2Choice<String>(value: 'vzon2', title: 'Tuesday'),
  S2Choice<String>(value: 'vzon3', title: 'Wednesday'),
];

List<S2Choice<String>> wards = [
  S2Choice<String>(value: 'mon', title: 'Monday'),
  S2Choice<String>(value: 'tue', title: 'Tuesday'),
  S2Choice<String>(value: 'wed', title: 'Wednesday'),
  S2Choice<String>(value: 'thu', title: 'Thursday'),
