...
class DhanvantariEventsDownload extends StatefulWidget {

  @override
  _DhanvantariEventsDownloadState createState() =>
      _DhanvantariEventsDownloadState();

}

class _DhanvantariEventsDownloadState extends State<DhanvantariEventsDownload>
{
    ...
    return ProgressButton.icon(
        ...
        iconedButtons: {
          ButtonState.idle: IconedButton(
              text: "Dhanvantari Maiyam Event List",
          ...
          ButtonState.success: IconedButton(
              text: "Share Dhanvantari Maiyam Events file",
              icon: Icon(
                Icons.share,
                color: Colors.white,
              ),
