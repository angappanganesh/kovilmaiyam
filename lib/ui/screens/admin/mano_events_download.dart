...
class ManoEventsDownload extends StatefulWidget {

  @override
  _ManoEventsDownloadState createState() =>
      _ManoEventsDownloadState();

}

class _ManoEventsDownloadState extends State<ManoEventsDownload>
{
    ...
    return ProgressButton.icon(
        ...
        iconedButtons: {
          ...
          ButtonState.success: IconedButton(
              text: "Share Mano Maiyam Events file",
              icon: Icon(
                Icons.share,
                color: Colors.white,
              ),
