...
class SakthiEventsDownload extends StatefulWidget {

  @override
  _SakthiEventsDownloadState createState() =>
      _SakthiEventsDownloadState();

}

class _SakthiEventsDownloadState extends State<SakthiEventsDownload>
{
    ...
    return ProgressButton.icon(
        ...
        iconedButtons: {
          ...
          ButtonState.success: IconedButton(
              text: "Share Shakti Maiyam Events file",
              icon: Icon(
                Icons.share,
                color: Colors.white,
              ),
