...
class PrabanjaNewEvent extends StatelessWidget {
  final Maiyam maiyam;

  const PrabanjaNewEvent({Key key, this.maiyam}) : super(key: key);
        ...
        body: Scrollbar(
          child: ListView(
            children: <Widget>[
              KeepAliveWidget(
                child: StickyHeader(
                  header: const FeaturesHeader('Record Prabanja Maiyam Activity'),
    ...
    return Column(
      children: <Widget>[
        ...
        SmartSelect<String>.single(
          title: 'Activity Type',
          value: _activityType,
          choiceItems: choices.prabanja_activity_type,
        ...
        Padding(padding: EdgeInsets.fromLTRB(15.0, 0.0, 15.0, 0.0),
          child: TextField(
            ...
            decoration: new InputDecoration(
              ...
              //hintText: '',
              labelText: 'No of plants distributed',
