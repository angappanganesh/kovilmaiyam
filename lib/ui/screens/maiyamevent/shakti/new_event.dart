...
class ShakthiNewEvent extends StatelessWidget {
  final Maiyam maiyam;

  const ShakthiNewEvent({Key key, this.maiyam}) : super(key: key);
        ...
        body: Scrollbar(
          child: ListView(
            children: <Widget>[
              KeepAliveWidget(
                child: StickyHeader(
                  header: const FeaturesHeader('Record Shakthi Maiyam Activity'),
...
class _FeaturesSingleSheetState extends State<FeaturesSingleSheet> {
  ...
  String _activityType = 'navarathri';
    ...
    return Column(
      children: <Widget>[
        ...
        SmartSelect<String>.single(
          title: 'Activity Type',
          value: _activityType,
          choiceItems: choices.shakthi_activity_type,
        ...
        Padding(padding: EdgeInsets.fromLTRB(15.0, 0.0, 15.0, 0.0),
          child: TextField(
            ...
            decoration: new InputDecoration(
              ...
              //hintText: '',
              labelText: 'No of Volunteers Involved',
        ...
        Padding(padding: EdgeInsets.fromLTRB(15.0, 0.0, 15.0, 0.0),
          child: TextField(
            ...
            decoration: new InputDecoration(
              ...
              //hintText: '',
              labelText: 'No of Children Involved',
              //prefixIcon: const Icon(Icons.person, color: Colors.blue,),
              prefixText: ' ',
              suffixText: '#',
              suffixStyle: const TextStyle(color: Colors.green),
