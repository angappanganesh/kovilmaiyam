...
class PhotosExplorer extends StatefulWidget {
  // some URL like 'https://photos.google.com/share/AF1QipOHA3tBezjmlKx9grmFwcRPoTpFA36FS8OIC7bVXox79GNSR0zxPZW-JDowmv-BAA?key=QWMyLUZxRkNITE10amtxc3NYRXBqV0QyQ3RWdm5n'
  final String photosUrl;

  PhotosExplorer({Key key, @required this.photosUrl}) : super(key: key);

  @override
  _PhotosExplorerState createState() => _PhotosExplorerState();
}

class _PhotosExplorerState extends State<PhotosExplorer> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Photos Explorer'),
        ...
        return PopupMenuButton<String>(
          onSelected: (String value) async {
            if (value == 'Email link') {
              var url = await controller.data.currentUrl();
              await launch(
                  'mailto:?subject=Check out this Photos page&body=$url');
            } else {
